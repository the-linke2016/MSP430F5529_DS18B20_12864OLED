...
//DS18B20控制脚，单脚控制
#define DQ_IN	        P2DIR &= ~BIT4		  //设置输入，DS18B20接单片机P53口
#define DQ_OUT	        P2DIR |= BIT4		  //设置输出
#define DQ_CLR	        P2OUT &= ~BIT4	          //置低电平
#define DQ_SET	        P2OUT |= BIT4	          //置高电平
#define DQ_R	        P2IN & BIT4		  //读电平
uint    temp_value;
uint    temp;
